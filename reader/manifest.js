...
window.ACADEMY_PROJECTS = [
  ...
  { id: "26-destruction", title: "Destruction Engine", tier: "hard", language: "Python", status: "available",
    pitch: "A building is just blocks held by breakable bonds — brace it so it stands, then let a blast or a quake snap it into a pile of rubble." },
  { id: "27-voxel-sandbox", title: "Voxel Sandbox", tier: "hard", language: "Python", status: "available",
    pitch: "Every pixel is one material obeying a few local rules — and sand piles, water finds its level, lava chills to stone, and fire eats the wood." },
  { id: "28-digital-brain", title: "Digital Brain", tier: "hard", language: "Python", status: "available",
    pitch: "A sheet of spiking cells, each exciting its neighbours and hushing the ones beyond — poke it into rippling waves, and it learns the paths it fires most." },
  { id: "29-earth-simulator", title: "Earth Simulator", tier: "epic", language: "Python", status: "available",
    pitch: "Sunlight in, heat radiated out, winds dragging warmth poleward — an energy budget alone conjures climate bands, seasonal ice caps, and green continents." },
  { id: "30-universe-sandbox", title: "Universe Sandbox", tier: "epic", language: "Python", status: "available",
    pitch: "Nothing but Newton's 1/r-squared law summed over every pair of bodies — and stars wheel into galaxies, black holes orbit, and colliding disks fling tidal tails." },
];
