"""Universe Sandbox: direct N-body gravity with softening and a symplectic leapfrog — rotating
...
def make_galaxy(n, center, bulk_vel, spin=1.0, radius=0.22, seed=0):
...
def apply_seed(scene="collide", seed=1):
